...
import 'package:insurance_boost/src/features/authentication/controllers/otp_controller.dart';
      ...
      body: Container(
        ...
        child: Column(
          ...
          children: [
            ...
            const Text("$tOtpMessage support@ensurance.com", textAlign: TextAlign.center),
