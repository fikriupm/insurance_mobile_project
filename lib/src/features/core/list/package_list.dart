...
import 'package:insurance_boost/src/features/core/api/package.dart';
import 'package:insurance_boost/src/features/core/screens/dashboard/rewards/package_detail_page.dart';
          ...
          actions: <Widget>[
            ...
            TextButton(
              ...
              onPressed: () async {
                ...
                await HistoryApi()
                    .newHistory(DateTime.now(), 'Cost', num, price, me.id!);
                await PackageApi().buyPackage(DateTime.now(), me.id!, code,
